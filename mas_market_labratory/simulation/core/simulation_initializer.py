...
from environment.configs import environment_configuration
from mas_market_labratory.environment.views.economy_insight_view import EconomyInsightView
from mas_market_labratory.environment.views.market_data_view import MarketDataView
from simulation.models.simulation_configurations import SimulationConfigurations, get_simulation_configurations 
from simulation.models import simulation_configurations
from simulation.models.simulation_realtime_data import SimulationRealTimeData
from simulation.models import simulation_realtime_data
...
class SimulationInitializer:
    ...
    def INITIALIZE_ENVIRONMENT(environment_config:Dict[str, Any]) -> None:
        ...
        environment_configuration.__ENVIRONMENT_CONFIGURATION = EnvironmentConfiguation(
    ...
    def INITIALIZE_SIMULATION(simulation_config:Dict[str, Any]) -> None:
        ...
        simulation_micro_tick = simulation_config["simulation_mairo_tick"]
        ...
        simulation_configurations.__SIMULATION_CONFIGURATION = SimulationConfigurations(
    ...
    @staticmethod
    def INITIALIZE_REALTIME_DATA(init_economy_insight_view:EconomyInsightView, init_market_data_view:MarketDataView) -> None:
        SIM_CONFIG = get_simulation_configurations()
        simulation_realtime_data.__SIMULATION_REALTIME_DATA = SimulationRealTimeData(
            ...
            economy_insight_view=init_economy_insight_view,
